/**
 * Point d'entrée unique du dossier models/
 * Réexporte tous les types et interfaces métier de l'application.
 */

export type { CardHolder, CreateCardHolderDto, UpdateCardHolderDto } from "./CardHolder"
